...
class LinkMLInstance:
    ...
    def validation_issues(self) -> builtins.list[ValidationIssue]: ...
...
def load_json(source:typing.Any, sv:SchemaView, class_view:ClassView) -> tuple[typing.Optional[LinkMLInstance], builtins.list[ValidationIssue]]: ...

def load_yaml(source:typing.Any, sv:SchemaView, class_view:ClassView) -> tuple[typing.Optional[LinkMLInstance], builtins.list[ValidationIssue]]: ...
