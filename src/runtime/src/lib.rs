...
pub use diff::{
    diff, element_identity_label, list_path_segment, list_path_segments, patch,
    slot_declares_element_identity, Delta, DeltaOp, DiffOptions, PatchOptions, PatchTrace,
    OPAQUE_ANNOTATION,
};
